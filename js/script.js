...
/* 		$("#news_8title_ph").html(selectedCountry.sites);
	...
	educationDiv.addEventListener('click', function(event) {
		...
		$("#annualgovedexpense_ph").text(selectedCountry.lifeexpectancy['value']);
		$("#literacy_ph").text(selectedCountry.infantMortality['value']);
		$("#enrollmentpreprimary_ph").text(selectedCountry.deathrate['value']);
		$("#enrollmentprimary_ph").text(selectedCountry.commdeaths['value']);
		$("#enrollmentsecondary_ph").text(selectedCountry.deathsroad['value']);
		$("#enrollmenttertiary_ph").text(selectedCountry.diabetes['value']);
		$("#trainedteachersprimary_ph").text(selectedCountry.overweight['value']);
		$("#teacherpupilratio_ph").text(selectedCountry.undernourishment['value']);
		$("#primaryeducationcompletion_ph").text(selectedCountry.underweight['value']);
		$("#govedexpenseprimary_ph").text(selectedCountry.underweight['value']);
